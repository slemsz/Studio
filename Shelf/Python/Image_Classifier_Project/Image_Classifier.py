...
# kernel size: 3x3 kernel or filter matrix used to calculate output features
...
# activation: relu because it works very well
...
# Final dense layer used to product the output for each of the 10 categories
